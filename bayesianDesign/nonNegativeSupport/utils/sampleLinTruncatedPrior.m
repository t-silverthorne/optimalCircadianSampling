function X = sampleLinTruncatedPrior(N,settings)
if nargin<2
...
pfun=@(p) normpdf(p,[mu1,mu2,mu3],[sig1,sig2,sig3]); % TODO check this evaluates Gaussian columnwise with correct mean
