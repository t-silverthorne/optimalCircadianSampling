...
opts = optimoptions(@particleswarm,'HybridFcn',@fminsearch,'SwarmSize',300);
thetaest=particleswarm(@(x) wrapExpectedBayesianFIM(NL,NR,x(1),x(1)+x(2),M,fnames,tobs_mat_nu, ...
                                Yobs_mat_nu,model,method,settings), ...
                                2,[],[],opts);
